...
To get started with Kaltura VPaaS, you will need to first need to [register with Kaltura VPaaS](https://vpaas.kaltura.com/register.html#sthash.vIwDFes1.dpbs).
