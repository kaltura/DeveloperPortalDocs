---
layout: page
title: Kaltura Mobile SDK 2.0 Introduction
weight: 100
---
...
To create custom plugins, follow the steps in the article [Extending the Player with Plugins](https://vpaas.kaltura.com/documentation/media-player/Player-Plugins#sthash.gtmiiI7F.dpbs).
