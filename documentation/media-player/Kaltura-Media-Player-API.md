...
* `targetId`:String - Id of the DOM element where the player will be rendered (any contents of the element will be removed when the player is rendered instead of this given element). 
* [`settings`](#the-kwidget-settings-object):Objec - Object of settings properties to be used when building and rendering the player. 
